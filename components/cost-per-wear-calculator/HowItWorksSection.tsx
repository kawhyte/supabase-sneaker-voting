      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
            ...
            <strong className="text-white">True Net Cost</strong>.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-6 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/8 transition-colors">
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-2 flex-1">
                <h3 className="text-lg font-bold text-white">2. Quality Over Quantity</h3>
                <p className="text-sm text-slate-400 leading-relaxed">
                  Cheap items often cost more in the long run because they don&apos;t last.
                  Our algorithm rewards{' '}
                  <strong className="text-white">&ldquo;High Quality&rdquo;</strong> ratings by
          ...
          <div className="p-6 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/8 transition-colors">
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-2 flex-1">
                <h3 className="text-lg font-bold text-white">3. The Clutter Penalty</h3>
                <p className="text-sm text-slate-400 leading-relaxed">
                  Buying a duplicate of something you already own reduces the value of both items.
                  We apply a <strong className="text-white">&ldquo;Clutter Penalty&rdquo;</strong> to
                  duplicates and a{' '}
                  <strong className="text-white">&ldquo;Utility Bonus&rdquo;</strong> to items
          ...
          <div className="p-6 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/8 transition-colors">
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-2 flex-1">
                <h3 className="text-lg font-bold text-white">4. The &ldquo;Smart Buy&rdquo; Score</h3>
                <p className="text-sm text-slate-400 leading-relaxed">
                  We combine all these factors into a single{' '}
                  <strong className="text-white">0–100 Score</strong>.{' '}
        ...
        <div className="bg-white/5 rounded-2xl border border-white/10 overflow-hidden">
          <div className="p-6 border-b border-white/10">
            ...
            <p className="text-slate-400 text-sm mt-1">Why &ldquo;Cheap&rdquo; isn&apos;t always &ldquo;Good Value&rdquo;</p>
          </div>

          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left">
              <thead className="text-slate-500 font-semibold uppercase text-xs tracking-wider">
                <tr>
              ...
              <tbody className="divide-y divide-white/5">
                <tr className="border-l-2 border-primary hover:bg-white/5 transition-colors">
                  <td className="px-6 py-4 font-medium text-white flex items-center gap-2">
                    <Footprints className="h-4 w-4 text-slate-400 flex-shrink-0" /> Limited Jordans
                  </td>
                  <td className="px-6 py-4 text-slate-300">$220</td>
                ...
                <tr className="border-l-2 border-red-500 hover:bg-white/5 transition-colors">
                  <td className="px-6 py-4 font-medium text-white flex items-center gap-2">
                    <Shirt className="h-4 w-4 text-slate-400 flex-shrink-0" /> Fast Fashion Tee
                  </td>
