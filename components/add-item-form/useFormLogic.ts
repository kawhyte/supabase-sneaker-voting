		...
		defaultValues:
			mode === 'edit' && initialData
				? {
						...
						sizeTried: initialData.status !== 'wishlisted' ? (initialData.size_tried || '') : '',
						target_size: initialData.status === 'wishlisted' ? (initialData.size_tried || '') : '',
						enableTracking: initialData.auto_price_tracking_enabled || false,
