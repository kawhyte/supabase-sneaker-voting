...
export function AddItemForm({
	...
	// Load size preferences when brand changes
	// Note: Size preferences will be loaded based on authenticated user
	useEffect(() => {
		// Size preference loading is disabled for now
		// TODO: Update size preferences to use user_id instead of user_name
	}, [watchedBrand]);
			...
			<Card
				...
				<CardContent>
					...
					<form
						...
						{/* Experience, and Category - Required First */}
						...
						{((watchedInteractionType && watchedCategory) ||
							mode === "edit") && (
							<>
