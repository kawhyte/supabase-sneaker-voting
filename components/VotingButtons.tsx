...
export default function VotingButtons({handleRating, vote}:{handleRating:any, vote:any}) {
  ...
  return (
    ...
    <span
        className={`absolute top-8 md:scale-0 transition-all mt-5 text-center rounded bg-gray-800  text-[0.67rem] sm:text-xs text-white md:group-hover:scale-100 ${
            vote === "1" ? "scale-100" : ""
        }`}>
        I love it!
    </span>
