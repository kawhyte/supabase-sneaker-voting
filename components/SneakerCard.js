											...
											<div className='p-1'>
												<Card>
													<CardHeader className='bg-white'>
														<span className=' font-semibold max-w-lg flex aspect-square items-center justify-center '>
															<img
													...
													<CardContent className='bg-gray-800 pt-5'>
														<h5 className=' font-mono flex flex-col normal-case text-start  drop-shadow-xl  text-[1.1rem] sm:text-[0.89rem] tracking-[-0.01em] leading-[1.33] font-semibold'>
