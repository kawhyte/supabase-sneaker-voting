					...
					<div className='flex flex-row justify-evenly sm:justify-between bg-gray-600 rounded-xl  max-w-sm  mb-8  sm:my-7 '>
						...
						<div className=' flex justify-end  '>
							<div className='relative group flex flex-col items-center align-middle justify-center'>
								...
								<span
									className={`absolute top-8 md:scale-0 transition-all mt-4 text-center rounded bg-gray-800  text-[0.67rem] sm:text-xs text-white md:group-hover:scale-100 ${
										vote === "1" ? "scale-100" : ""
									}`}>
									Love it!
								</span>
							...
							<div className='relative group flex justify-center flex-col items-center align-middle'>
								...
								<span
									className={`absolute top-8 md:scale-0 transition-all mt-4 text-center rounded bg-gray-800  text-[0.69rem] sm:text-xs text-white md:group-hover:scale-100 ${
										vote === "4" ? "scale-100" : ""
									}`}>
									Like it
								</span>
