...
export function NotificationSettings() {
  ...
  const getPermissionBadge = () => {
    switch (permission) {
      ...
      case 'default':
        return <Badge className="bg-primary text-primary border-primary"><AlertCircle className="w-3 h-3 mr-1" />Not Set</Badge>;
      default:
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {permission === 'denied' && (
          <div className="rounded-md bg-primary border border-primary p-4">
            <div className="text-sm">
              <strong className="text-primary">Permission Denied</strong>
