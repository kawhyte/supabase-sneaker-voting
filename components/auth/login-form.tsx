    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <Card className="overflow-hidden p-0 rounded-[2rem] border-slate-200 shadow-xl bg-white">
        <CardContent className="grid p-0 md:grid-cols-2 min-h-[600px]">
          ...
          <form action={formAction} className="p-8 md:p-12 flex flex-col justify-center">
            <FieldGroup className="space-y-6">
              ...
              <Field className="pt-2">
                <SubmitButton
                  className="w-full h-12 bg-primary hover:bg-primary hover:scale-[1.02] active:scale-[0.98] text-slate-950 font-bold text-lg rounded-full transition-all"
              ...
              <Field className="grid grid-cols-3 gap-3">
                <Button variant="outline" type="button" className="h-12 rounded-xl border-slate-200 hover:bg-slate-50/60 transition-all">
                   {/* Apple Icon */}
          ...
          {/* RIGHT SIDE: Editorial Dark Panel */}
          <div
            className="hidden md:flex relative bg-slate-950 items-center justify-center p-12"
            style={{
              backgroundImage: 'radial-gradient(circle, rgba(255,255,255,0.05) 1px, transparent 1px)',
              backgroundSize: '28px 28px',
            }}
          >
            <div className="relative z-10 flex flex-col items-start text-left space-y-4 max-w-[300px]">
              <div className="w-8 h-px bg-primary" />
              <h3 className="text-2xl font-bold text-white leading-snug">
                The Collector&apos;s Dashboard
              </h3>
              <p className="text-sm text-slate-400 leading-relaxed">
                Track market values, monitor Cost Per Wear, and curate your rotation.
              </p>
            </div>
          </div>
        </CardContent>
