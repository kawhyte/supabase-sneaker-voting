...
function LottieAnimationWrapper() {
  ...
  if (!animationData) return <div className="w-full h-64 bg-slate-100 rounded-full animate-pulse" />

  return (
    <div className="w-full max-w-[320px] aspect-square relative z-10">
      {/* Soft Glow behind the cat */}
      <div className="absolute inset-0 bg-primary/40 blur-[60px] rounded-full transform scale-75" />
      <Lottie
        loop
        play
...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <Card className="overflow-hidden p-0 rounded-[2rem] border-slate-200 shadow-xl bg-white">
        <CardContent className="grid p-0 md:grid-cols-2 min-h-[600px]">
            ...
            <FieldGroup className="space-y-6">
              ...
              <div className="flex flex-col gap-2 mb-4">
                <div className="flex items-center gap-2 mb-2">
                   <span className="px-3 py-1 rounded-full bg-primary text-primary text-xs font-bold uppercase tracking-wider">
                     Member Access
                   </span>
                </div>
              ...
              <Field>
                ...
                <Input
                  ...
                  className="h-12 rounded-xl border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-primary focus:border-primary transition-all font-medium"
                />
              </Field>
              ...
              <Field className="pt-2">
                <SubmitButton
                  className="w-full h-12 bg-primary hover:bg-primary hover:scale-[1.02] active:scale-[0.98] text-slate-950 font-bold text-lg rounded-full transition-all shadow-sm"
              ...
              <Field className="grid grid-cols-3 gap-3">
                <Button variant="outline" type="button" className="h-12 rounded-xl border-slate-200 hover:bg-slate-50 hover:border-slate-300 transition-all">
                   {/* Apple Icon */}
              ...
              <FieldDescription className="text-center text-slate-500 font-medium">
                ...
                <a href="/signup" className="font-bold text-slate-900 hover:text-primary underline-offset-4 hover:underline transition-colors">
                  Sign up
                </a>
              </FieldDescription>
          ...
          <div className="hidden md:flex relative bg-slate-100 items-center justify-center p-12">
            {/* Background Pattern or Gradient */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-white/50 to-slate-100/0" />
