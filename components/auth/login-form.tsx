            ...
            <FieldGroup>
              ...
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-muted-foreground text-balance text-sm">
                  Login to your Sneaker Tracker account
                </p>
              </div>
              ...
              <Field>
                ...
                <Input
                  ...
                  required
                  className="focus:ring-2 focus:ring-sun-500 focus:ring-offset-2"
                />
              </Field>
              ...
              <Field>
                <SubmitButton
                  className="w-full h-10 bg-sun-500 hover:bg-sun-600 disabled:opacity-75 text-black font-medium rounded-md transition-colors"
              ...
              {searchParams?.message && (
                <div className="p-4 rounded-md bg-sun-100 border border-sun-200 text-center">
                  <p className="text-sm font-medium text-sun-900">{searchParams.message}</p>
                </div>
              )}
            </FieldGroup>
          </form>
