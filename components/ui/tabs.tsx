...
const TabsList = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof TabsPrimitive.List> & { 'data-variant'?: string }
>(({ className, 'data-variant': variant, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
...
const TabsTrigger = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof TabsPrimitive.Trigger> & { 'data-variant'?: string }
>(({ className, 'data-variant': variant, children, ...props }, ref) => (
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      "mt-md ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 transition-all duration-300 data-[state=inactive]:opacity-0 data-[state=inactive]:pointer-events-none data-[state=active]:opacity-100",
      className
    )}
    {...props}
  />
